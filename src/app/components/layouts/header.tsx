    ...
    return (
        <header className='top-0 left-0 w-full p-[20px_120px] fixed bg-transparent flex items-center justify-between z-100 backdrop-blur-[16px] border-b-[1px] border-[#ffffff5b]'>
            ...
            <nav className='inline-block max-lg:hidden'>
                <Link href={"/#accueil"} className='ml-[3.5rem] text-white no-underline text-3xl	font-[500] transition duration-[.3s] hover:text-[#8a2be2]'>accueil</Link>
                <Link href={"/#about"} className='ml-[3.5rem] text-white no-underline text-3xl	font-[500] transition duration-[.3s] hover:text-[#8a2be2]'>A propos</Link>
