    ...
    return (
        <section className=" flex flex-col justify-center items-center gap-[2rem] bg-transparent backdrop-blur-[15px]">
            <div className=" justify-between ml-[1.6rem]">
                ...
                <p className=" text-white text-[1.6rem] m-[2rem_0_3rem]">Je suis âgé de 20 ans, actuellement étudiant en 2e année de BTS SIO option SLAM au Lycée polyvalent de Cachan. </p>
            </div>
